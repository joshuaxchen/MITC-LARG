class PlotWriter:
    colors=["blue","red","green", "brown", "cyan", "darkgray", "lime", "magenta", "olive", "orange", "pink", "purple","lightgray",  "teal", "violet", "yellow", "Bittersweet", "BlueViolet","gray",  "BrickRed", "BurntOrange", "CadetBlue", "CarnationPink", "Cerulean", "Dandelion", "DarkOrchid", "Emerald", "Fuchsia", "GreenYellow", "Magenta", "Maroon", "MidnightBlue", "Orange", "OrangeRed", "Orchid", "Periwinkle", "RawSienna"]
