...
def compare_av_placement(summary, human, evaluation_key="even_evalution", inflows_keys=["1650", "1850", "2000"]):
    ...
    for inflow in inflows_keys:
        ...
        if attr_name=="Speed":
            inflow_plot.set_plot_range(1500, 2000, 5, 21)
            avp_plot.set_plot_range(0, 40, 5, 21)
        elif attr_name=="Outflow":
            inflow_plot.set_plot_range(1500, 2000, 1500, 1850)
...
def retrieve_all_data_and_plot():
    ...
    compare_av_placement(even_evaluation_summary, even_human, evaluation_key="even_evaluation", inflows_keys=["2000"]) 
    compare_av_placement(random_evaluation_summary, random_human, evaluation_key="random_evaluation", inflows_keys=["2000"])
