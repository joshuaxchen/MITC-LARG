TRAIN_DIR_30=/home/users/flow_user/ray_results/yulin_multiagent_highway_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/count_ahead_avp30_main2000_merge200
TRAIN_DIR_50=/home/users/flow_user/ray_results/yulin_multiagent_highway_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/count_ahead_avp50_main2000_merge200
TRAIN_DIR_70=/home/users/flow_user/ray_results/yulin_multiagent_highway_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/count_ahead_avp70_main2000_merge200
TRAIN_DIR_90=/home/users/flow_user/ray_results/yulin_multiagent_highway_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/count_ahead_avp90_main2000_merge200
...
#do
#	python3 flow/visualize/new_rllib_visualizer.py $TRAIN_DIR_30 $CHCKPOINT --render_mode no_render --handset_avp ${AVP} >> ./exp_results/avp_count_ahead/av30/merge4_2000_200_TAVP_30_EAVP_${AVP}.txt
#done
#
#for AVP in 2 4 6 8 10 30 50 70 80 100
#do
#	python3 flow/visualize/new_rllib_visualizer.py $TRAIN_DIR_70 $CHCKPOINT --render_mode no_render --handset_avp ${AVP} >> ./exp_results/avp_count_ahead/av70/merge4_2000_200_TAVP_70_EAVP_${AVP}.txt
#done

for AVP in 4 
do
	python3 flow/visualize/new_rllib_visualizer.py $TRAIN_DIR_50 $CHCKPOINT --render_mode no_render --handset_avp ${AVP} >> ./exp_results/avp_count_ahead/av50/merge4_2000_200_TAVP_50_EAVP_${AVP}.txt &
done
