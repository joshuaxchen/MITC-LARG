TRAIN_DIR_10=/home/users/flow_user/ray_results/yulin_multiagent_highway_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/count_ahead_avp10_main2000_merge200
...
do
	python3 flow/visualize/new_rllib_visualizer.py $TRAIN_DIR_10 $CHCKPOINT --render_mode no_render --handset_avp ${AVP} >> ./exp_results/avp_count_ahead/av10/merge4_2000_200_TAVP_10_EAVP_${AVP}.txt
done
