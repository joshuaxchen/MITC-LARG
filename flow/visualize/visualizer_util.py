...
def reset_inflows(args, flow_params):
    ...
    if args.human_inflows and args.rl_inflows and args.rl_lane_change and args.human_lane_change and args.merge_inflow and args.aggressive and args.lc_probability:
