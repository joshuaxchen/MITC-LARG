...
def setup_exps(flow_params, args=None):
    ...
    """
    if args:
        params = read_params(args.dir + '/results/params_' + str(args.gen) + '_i_' + str(args.member_number) + '.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('gen', type=int, help='Generation to use')
    parser.add_argument('member_number', type=int, help='Id of Member to run')
    parser.add_argument('-o', '--output', help='Output File')
    args = parser.parse_args()
    with open(args.dir + '/config.json', 'r') as f:
        config = json.load(f)
    ...
    controller_class = __import__('flow.benchmarks.condor.es_controllers.%s' % controller_name, fromlist=["Controller"])
