...
def setup_exps(flow_params, args=None):
    ...
    if args:
        ...
        vehicles.add(
            veh_id="rl",
            acceleration_controller=(IDMController, {'T': args.params[0], 's0':args.params[1], 
                'delta':args.params[2]}),
            car_following_params=SumoCarFollowingParams(
                speed_mode=9,
            ),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--params', type=str, help='IDM Parameters')
    parser.add_argument(
    ...
    controller = __import__('flow.controllers.car_following_models', fromlist=[args.controller_name])
