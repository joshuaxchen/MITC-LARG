...
plt.figure(1)
plt.title("Symmetric Inflow with Lane Change")
...
plt.ylabel('{}'.format(metric))
plt.title("Asymmetric Inflow No Lane Change, right inflow{}".format(right_inflow))
x=[1000, 1200, 1400, 1600, 1800, 2000]
fixed_attr = {'right_human_lc':0.0,
              'assertive':0.0,
              'speedgain':0.0,
...
plt.xlabel('Left Inflow')
plt.ylabel('{}'.format(metric))
plt.title("Asymmetric Inflow with Lane Change, right inflow{}".format(right_inflow))
x=[1000, 1200, 1400, 1600, 1800, 2000]
...
plt.xlabel('Left Inflow')
plt.ylabel('{}'.format(metric))
plt.title("Asymmetric Inflow without Lane Change, right inflow{}, speedgain {}".format(right_inflow, speedgain))
x=[1000, 1200, 1400, 1600, 1800, 2000]
asss = [0, 0.5, 1.0, 5.0, 10.0]
aggs = [0, 0.5, 1.0, 5.0, 10.0, 100.0, 1000.0, 10000.0]
fixed_attr = {'right_human_lc':1.0,
...
plt.xlabel('Left Inflow')
plt.ylabel('{}'.format(metric))
plt.title("Asymmetric Inflow without Lane Change, right inflow{}, assertive {}".format(right_inflow, assertive))
x=[1000, 1200, 1400, 1600, 1800, 2000]
asss = [0, 0.5, 1.0, 5.0, 10.0]
aggs = [0, 0.5, 1.0, 5.0, 10.0, 100.0, 1000.0, 10000.0]
fixed_attr = {'right_human_lc':1.0,
