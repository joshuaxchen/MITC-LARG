...
from flow.envs.multiagent import LeftLaneOvalAboutToMergeHighwayPOEnvMerge4Collaborate
...
exp_tag_str='multiagent'+mark+'_lanechange_left_oval_with_merger_eta1_{}_eta2_{}'.format(ETA_1, ETA_2)
...
flow_params = dict(
    exp_tag=exp_tag_str,
    env_name=LeftLaneOvalAboutToMergeHighwayPOEnvMerge4Collaborate,
