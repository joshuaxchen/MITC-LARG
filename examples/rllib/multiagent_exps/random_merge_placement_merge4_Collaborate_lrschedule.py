...
from flow.envs.multiagent import MultiAgentHighwayPOEnvMerge4RandomMergeCollaborate
...
exp_tag_str='{}_merge_placement_augmented'.format(random_prefix)+mark+'_merge4_Full_Collaborate_lr_schedule_eta1_{}_eta2_{}'.format(ETA_1, ETA_2)

flow_params = dict(
    exp_tag=exp_tag_str,
    env_name=MultiAgentHighwayPOEnvMerge4RandomMergeCollaborate, #MultiAgentHighwayPOEnvMerge4Collaborate,
