...
from flow.envs.multiagent import MultiAgentHighwayPOEnvMerge4HierarchyVehiclesBetweenNextRL
...
flow_params = dict(
    exp_tag='yulin_countbetween_hierarchy_eta1_{}_eta2_{}'.format(ETA_1, ETA_2),

    env_name=MultiAgentHighwayPOEnvMerge4HierarchyVehiclesBetweenNextRL,
