...
TRAINED_POLICY=~/ray_results/yulin_hierarchy_eta1_0.9_eta2_0.1/aamas_full

for AVP in 10  
do
	python3 ../../examples/rllib/multiagent_exps/countbetween_hierarchical_policy.py --avp ${AVP} --policy_dir ${TRAINED_POLICY}
done
