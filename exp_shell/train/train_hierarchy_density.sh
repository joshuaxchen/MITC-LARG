...
TRAINED_POLICY=~/ray_results/yulin_multiagent_highway_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/aamas_full

for AVP in 10  
do
	python3 ../../examples/rllib/multiagent_exps/densityahead_hierarchical_policy.py --avp ${AVP} --policy_dir ${TRAINED_POLICY}
done
