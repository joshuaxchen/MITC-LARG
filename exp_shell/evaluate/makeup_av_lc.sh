...
EXP_FOLDER=$FLOW_DIR/exp_results/deterministic_action_random_lane_change/
...
for RIGHT_MAIN_INFLOW in 1600  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
do
	for LEFT_MAIN_INFLOW in 2000  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
	do
		...
		do
		    ...
		    for AVP_RIGHT in 20 #10 20 30 #20 30 40 #10 20 30 40 #200 400 600 800 # 200 400 600 800 # 200 400 600 800
		    do
...
WORKING_DIR=$EXP_FOLDER/aamas_left_on_left
mkdir ${WORKING_DIR}


for RIGHT_MAIN_INFLOW in 2000 # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
do
	for LEFT_MAIN_INFLOW in 1800  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
	do
