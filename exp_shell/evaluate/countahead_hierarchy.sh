...
TRAIN_DIR_2=/home/users/flow_user/ray_results/yulin_countahead_hierarchy_eta1_0.9_eta2_0.1/countahead_hierarchy_aamas

#yulin_hierarchy_eta1_0.9_eta2_0.1/hierarchy_based_on_aamas_full
...
do
	python3 $VISUALIZER $TRAIN_DIR_2 $CHCKPOINT --render_mode no_render --seed_dir $FLOW_DIR --handset_avp ${AVP} --policy_dir /home/users/flow_user/ray_results/yulin_hierarchy_eta1_0.9_eta2_0.1/aamas_full >> $EXP_FOLDER/hierarchy/countahead_aamas/merge4_2000_200_TAVP_10_EAVP_${AVP}.txt 
done
...
for AVP in 30 40 #40 50 60 70 80 100
do
	python3 $VISUALIZER $TRAIN_DIR_2 $CHCKPOINT --render_mode no_render --seed_dir $FLOW_DIR --handset_avp ${AVP} --policy_dir /home/users/flow_user/ray_results/yulin_hierarchy_eta1_0.9_eta2_0.1/aamas_full >> $EXP_FOLDER/hierarchy/countahead_aamas/merge4_2000_200_TAVP_10_EAVP_${AVP}.txt &
done
