...
MAX_CPU=25
mkdir ${EXP_FOLDER}
WORKING_DIR=$EXP_FOLDER/human_speedgain_x_assertive_lanechange
mkdir ${WORKING_DIR}
RIGHT_MAIN_INFLOW=2000

for RIGHT_MAIN_INFLOW in 1600  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
do
    for LEFT_MAIN_INFLOW in 1400 1200 1000 #1700 1800 1900 2000  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
    do
        ...
        do
            ...
            do
                ...
                do 
                    for LEFT_HUMAN_LANE_CHANGE in 0 1
                    do
                            ...
                            do
                                ...
                                do
                                    python3 $VISUALIZER \
                                        ...
                                        --human_lane_change ${RIGHT_HUMAN_LANE_CHANGE} ${LEFT_HUMAN_LANE_CHANGE} \
                                        --rl_lane_change 0 0 \
					...
					--to_probability \
                                        ...
                                        >> ${WORKING_DIR}/EVAL_LEFT${LEFT_MAIN_INFLOW}_RIGHT${RIGHT_MAIN_INFLOW}_MERGE${MERGE_INFLOW}_AVP${AVP}_RLPOS${RL_RIGHT_LEFT}_RIGHTHUMANLC${RIGHT_HUMAN_LANE_CHANGE}_LEFTHUMANLC${LEFT_HUMAN_LANE_CHANGE}_SPEEDGAIN${SPEED_GAIN}_ASSERTIVE${ASSERTIVE}_${LC_PROB}.txt &
