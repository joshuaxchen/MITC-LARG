...
LEFT_DIR=${HOME}/ray_results/multiagent_new_rl_right_decisive_lanechange_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/PPO_MultiAgentHighwayPOEnvMerge4Collaborate-v0_7b738_00000_0_2021-12-01_22-29-47/
BOTH_DIR=${HOME}/ray_results/multiagent_new_rl_both_decisive_lanechange_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/PPO_MultiAgentHighwayPOEnvMerge4Collaborate-v0_fb42c_00000_0_2021-12-05_11-37-13/
...
for RIGHT_MAIN_INFLOW in 1600 1700 1800 1900 2000 #2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
#for RIGHT_MAIN_INFLOW in 1600 1700 #2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
do
	...
	#for LEFT_MAIN_INFLOW in 1000 1200 1400 # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
	do
		...
		do
			...
			do
				...
				do
					...
					$RIGHT_DIR \
					$CHCKPOINT \
					--agent_action_policy_dir $RIGHT_DIR \
					--seed_dir $FLOW_DIR \
...
##for RIGHT_MAIN_INFLOW in 1800 1900 2000 #2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
#for RIGHT_MAIN_INFLOW in 1600 1700 1800 1900 2000 #2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
##for RIGHT_MAIN_INFLOW in 1600 1700 #2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 # #do
#	for LEFT_MAIN_INFLOW in 1000 1200 1400 1600 1800 2000 # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
#	#for LEFT_MAIN_INFLOW in 1600 1800 2000 # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
#	#for LEFT_MAIN_INFLOW in 1000 1200 1400 # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
#	do
...
#					$LEFT_DIR \
#					$CHCKPOINT \
#					--agent_action_policy_dir $LEFT_DIR \
#					--seed_dir $FLOW_DIR \
#					--lateral_resolution 3.2 \
#					--render_mode no_render \
#					--human_inflows ${HUMAN_INFLOW_RIGHT} ${HUMAN_INFLOW_LEFT}\
...
#					$BOTH_DIR \
#					$CHCKPOINT \
#					--agent_action_policy_dir $BOTH_DIR \
#					--seed_dir $FLOW_DIR \
#					--lateral_resolution 3.2 \
#					--render_mode no_render \
#					--human_inflows ${HUMAN_INFLOW_RIGHT} ${HUMAN_INFLOW_LEFT}\
