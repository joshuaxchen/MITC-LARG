...
for RIGHT_MAIN_INFLOW in 2000 #1800 2000  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
do
	for LEFT_MAIN_INFLOW in 1800 #1600 1800 2000  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
	do
		for AVP_LEFT in 10 #0 10 20 30 40 #40 #10 20 30 40 #200 400 600 800 # 200 400 600 800 # 200 400 600 800
		do
...
do
	...
	do
		for AVP_LEFT in 0 #0 10 20 30 40 #40 #10 20 30 40 #200 400 600 800 # 200 400 600 800 # 200 400 600 800
		do
		    let RL_INFLOW_LEFT=LEFT_MAIN_INFLOW*${AVP_LEFT}/100
		    let HUMAN_INFLOW_LEFT=LEFT_MAIN_INFLOW-RL_INFLOW_LEFT
