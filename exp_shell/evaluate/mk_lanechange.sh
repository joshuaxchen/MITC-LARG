...
do
	...
	do
		for AVP in 20 30 #200 400 600 800 # 200 400 600 800 # 200 400 600 800
		do
...
for RIGHT_MAIN_INFLOW in 2000  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
do
	for LEFT_MAIN_INFLOW in 1800 #1800 1900 2000  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
	do
		for AVP in 20 #200 400 600 800 # 200 400 600 800 # 200 400 600 800
		do
			let MAIN_RL_INFLOW=MAIN_INFLOW*${AVP}/100
			let MAIN_HUMAN_INFLOW=MAIN_INFLOW-MAIN_RL_INFLOW
			...
			do
				...
				do 
					...
					do
						for ASSERTIVE in 1 #0.5 #5 #0.4 0.6 0.8 1
						do
							for LC_PROB in 0.2 # 0.2 0.4 0.6 0.8 1
							do
								python3 $VISUALIZER \
									$RL_MODEL \
									$CHCKPOINT \
...
for RIGHT_MAIN_INFLOW in 2000  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
do
	for LEFT_MAIN_INFLOW in 1900 #1800 1900 2000  # 1800 #1900 2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
	do
		for AVP in 20 #200 400 600 800 # 200 400 600 800 # 200 400 600 800
		do
			let MAIN_RL_INFLOW=MAIN_INFLOW*${AVP}/100
