...
AAMAS_DIR=${HOME}/ray_results/yulin_random_placement_multiagent_Even_Avp30_Main2000_Merge200_highway_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/PPO_MultiAgentHighwayPOEnvMerge4Collaborate-v0_740c0_00000_0_2021-07-04_14-31-39/

FLOW_DIR=${PWD}/../..
VISUALIZER=$FLOW_DIR/flow/visualize/new_rllib_visualizer.py
EXP_FOLDER=$FLOW_DIR/exp_results
WORKING_DIR=$EXP_FOLDER/aamas_mor_random_main
...
do
	...
	do
		...
		for AVP in 0 10 #10 #5 10 20 30 40
		do
			let MAIN_RL_INFLOW=MAIN_INFLOW*AVP/100
			let MAIN_HUMAN_INFLOW=MAIN_INFLOW-MAIN_RL_INFLOW
			echo "INFLOW", $MAIN_HUMAN_INFLOW $MAIN_RL_INFLOW $MERGE_INFLOW
			echo $LOC1 $LOC2
			python3 $VISUALIZER \
				$TRAIN_DIR \
				$CHCKPOINT \
