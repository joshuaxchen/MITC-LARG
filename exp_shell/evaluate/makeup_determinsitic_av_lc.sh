...
EXP_FOLDER=$FLOW_DIR/exp_results/new_deterministic_action_random_lane_change/
...
for RIGHT_MAIN_INFLOW in 1600 #2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
do
	...
	do
		...
		do
		    ...
		    for AVP_RIGHT in 10 #10 20 30 40 #200 400 600 800 # 200 400 600 800 # 200 400 600 800
		    do
...
for RIGHT_MAIN_INFLOW in 1800 #2000 2100 2200 # 1800 1900 2000 2100 2200 #1800 1900 #
do
