...
TRAIN_DIR=/home/users/flow_user/ray_results/multiagent_highway_merge4_MOR_Collaborate_lrschedule_eta1_0.9_eta2_0.1/PPO_MultiAgentHighwayPOEnvMerge4CollaborateMOR-v0_96d1f_00000_0_2021-07-31_23-18-57

AAMAS_DIR=/home/users/flow_user/ray_results/yulin_random_placement_multiagent_Even_Avp30_Main2000_Merge200_highway_merge4_Full_Collaborate_lr_schedule_eta1_0.9_eta2_0.1/PPO_MultiAgentHighwayPOEnvMerge4Collaborate-v0_740c0_00000_0_2021-07-04_14-31-39/
...
for DIST_BETWEEN in 800 #400 600 800 
do
	...
	do
		...
		echo "Inflows:" $MAIN_HUMAN_INFLOW $MAIN_RL_INFLOW $MERGE_INFLOW
		echo $LOC1 $LOC2
		python3 $VISUALIZER \
			$TRAIN_DIR \
			$CHCKPOINT \
