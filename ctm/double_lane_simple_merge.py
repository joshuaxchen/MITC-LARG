...
class DoubleLaneSimpleMerge:
    ...
    before_merge_index=5, merge_cell_num=2, waiting_times=1, lanechange_factor=0.1):
        ...
        self.lanechange_factor=lanechange_factor
        ...
        self.main_right_inflow_n_t_table=list()
        self.main_right_inflow_n_t_table.append(main_n_0)

        self.main_left_inflow_n_t_table=list()
        self.main_left_inflow_n_t_table.append(main_n_0)

        print("The double-lane simple merge road has been initialized. Please specify the inflow in terms of veh/s. Additionally, the units used in the sytem are veh/s, m/s.")
    ...
    def step(self, specified_main_inflow, specified_merge_inflow):
        ...
        self.main_right_inflow_n_t_table.append(main_inflows)
    ...
    def compute_inflow(self):
        main_inflow=0
        time=0
        for main_inflow_t in self.main_right_inflow_n_t_table:
